...
export default function Footer() {
  ...
  return (
    <footer style={{ background:"#1e293b", color:"white", padding:"52px 48px 28px",
      fontFamily:"'Inter', sans-serif" }}>
      <div style={{ display:"grid", gridTemplateColumns:"1.8fr 1fr 1fr 1.4fr", gap:40, marginBottom:40 }}>
