...
import { Mail, Lock, Eye, EyeOff, BookOpen, HelpCircle, MessageSquare, RefreshCw } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="#" className="text-gray-600 hover:text-gray-900 text-sm font-medium">Research</Link>
          <Link href="#" className="text-gray-600 hover:text-gray-900 text-sm font-medium">Events</Link>
          <Link href="#" className="text-gray-600 hover:text-gray-900 text-sm font-medium">Contact</Link>
        </div>
        <div className="flex items-center gap-4">
          <Link href="/login" className="text-gray-700 text-sm font-medium hidden sm:block">Sign In</Link>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="bg-white rounded-2xl shadow-lg w-full max-w-4xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="relative w-full md:w-5/12 min-h-64 md:min-h-0 bg-blue-900 flex flex-col justify-end p-8">
            ...
            <div className="relative z-20">
              ...
              <p className="text-blue-100 text-sm leading-relaxed mb-6">
                Join our community to access over 2 million digital and physical titles, reserve study
                spaces, and join exclusive academic workshops.
              </p>
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-9 h-9 rounded-full border-2 border-white bg-blue-400 flex items-center justify-center text-white text-xs font-bold"
                    >
          ...
          <div className="w-full md:w-7/12 p-8 lg:p-10">
            ...
            <p className="text-gray-500 text-sm mb-7">Enter your details to register for your library account.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-start gap-2">
                ...
                <Label htmlFor="terms" className="text-sm text-gray-600 cursor-pointer leading-relaxed">
                  I agree to the{" "}
                  <Link href="#" className="text-teal-500 hover:underline">Terms of Service</Link>
                  {" "}and{" "}
      ...
      <footer className="py-5 px-4">
        <p className="text-center text-xs text-gray-400">
          © 2024 University Library Portal. All rights reserved. Professional academic information system.
        </p>
      </footer>
    </div>
  );
